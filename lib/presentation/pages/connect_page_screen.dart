...
class _ConnectPageState extends State<ConnectScreen> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        resizeToAvoidBottomInset: true, // permite a rolagem automática
        body: Stack(
          children: [
            Positioned(
              top: 0,
                                        ...
                                        children: [
                                          ...
                                          TextField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              contentPadding: EdgeInsets.only(
                                                  top: 10.0, bottom: 10.0, left: 26.0),
                                              ...
                                              errorBorder: OutlineInputBorder(
                                                borderRadius: BorderRadius.circular(30.0),
                                                borderSide: BorderSide(
                                                    color: _errorBorderColor, width: 2.0),
                                              ),
                                          ...
                                          TextField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              errorText:
                                              _submitted ? _passwordErrorText : null,
                                            ),
                                          ),
                                          SizedBox(height: 8),
                                          Align(
